...
void enableCoinAcceptor()  { digitalWrite(COIN_INHIBIT_PIN, HIGH); }  // HIGH = Relay ON (passes 12V) = accept
void disableCoinAcceptor() { digitalWrite(COIN_INHIBIT_PIN, LOW);  }  // LOW = Relay OFF (cuts 12V) = inhibit
